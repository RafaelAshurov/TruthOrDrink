<template>
    ...
    >
        ...
        <div class="question-wrapper" :style="{ 'border-color': getCategoryColor(myQuestions[counter].category) }">
            <div class="category-wrapper" :style="{ 'background-color': getCategoryColor(myQuestions[counter].category) }">
